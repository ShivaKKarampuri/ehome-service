							...
							<div class="table-responsive">
								<table class="table table-striped table-md">
									...
									<tbody class="tdata">
										...
										<tr id="id_{{@$list->id}}"> 
										  <td>{{ @$list->course_name == "" ? config('constants.empty') : str_limit(@$list->course_name, '50', '...') }}</td>
										  ...
										  <td><a href="{{URL::to('/admin/course/edit/'.base64_encode(convert_uuencode(@$list->id)))}}" class="btn btn-primary"><i class="fa fa-edit"></i></a> <a href="javascript:void(0);" onClick="deleteAction({{@$list->id}}, 'courses')" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
										</tr>  
										@endforeach 
									</tbody>
									@else
