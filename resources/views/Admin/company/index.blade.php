								...
								<table class="table table-striped table-md">
									...
									<tbody class="tdata">
										...
										<tr id="id_{{@$list->id}}">
										  ...
										  <td><a href="{{URL::to('/admin/company/edit/'.base64_encode(convert_uuencode(@$list->id)))}}" class="btn btn-primary"><i class="fa fa-edit"></i></a> <a href="javascript:void(0);" onClick="deleteAction({{@$list->id}}, 'admins')" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
										</tr>
										@endforeach 
									</tbody>
									@else
