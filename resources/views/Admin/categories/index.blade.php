		...
		<div class="section-body">
            <div class="row">
				...
				<div class="col-5 col-md-5 col-lg-5">
					<div class="card">
					{{ Form::open(array('url' => 'admin/categories/store', 'name'=>"add-category", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
							...
							<div class="form-group">
								...
								<select class="form-control" name="parent">
									<option value="0">None</option>
										<?php
											echo \App\Category::printTree($tree);
										?>
								</select>
							</div>
							<div class="form-group">
								...
								<table class="table table-striped">
									...
									@if(@$totalData !== 0)
										...
										<tr id="id_{{@$list->id}}">
										  ...
										  <td>@if($list->parent !=0) {{\App\Category::where('id', $list->parent)->first()->title}} @else - @endif</td>
										  ...
										  <td>
										  <a href="{{URL::to('/admin/categories/edit/'.base64_encode(convert_uuencode(@$list->id)))}}" class="btn btn-outline-primary">Edit</a>  
